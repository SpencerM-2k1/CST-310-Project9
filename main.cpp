...
int main() {
    ...
    // Pass skybox texture to the cube shader
    cubeShader.Use();
    glUniform1i(glGetUniformLocation(cubeShader.Program, "skybox"), 0); // Set skybox texture unit
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        //view_cube = glm::translate(view_cube, glm::vec3(0.0f, -20.0f, -5.0f)); // Translate cube back
        ...
        //view_cylinder = glm::translate(view_cylinder, glm::vec3(0.0f, 0.0f, 0.0f)); // Cylinder origin
        //view_cylinder = glm::translate(view_cylinder, glm::vec3(0.0f, 0.0f, 0.0f) + cylinderOffset); // Cylinder approximately offset to sphere origin
        view_cylinder = glm::translate(view_cylinder, glm::vec3(-1.2f, 0.0f, -5.0f) + cylinderOffset); // Translate cylinder back and to the left (from sphere origin)
        ...
        // view_sphere = glm::translate(view_sphere, glm::vec3(0.0f, 0.0f, 0.0f)); //Sphere origin
        //view_sphere = glm::translate(view_sphere, glm::vec3(0.4f, 2.94f, 0.15f)); // Sphere approximately offset to cylinder origin
        view_sphere = glm::translate(view_sphere, glm::vec3(1.2f, -3.0f, -5.5f) - cylinderOffset); // Translate sphere back, to the right, and down (from cylinder origin)
